    ...
    return (
      <div className="min-h-screen w-full flex bg-background -mt-6 md:-mt-8">
        ...
        <div className="hidden lg:flex w-1/2 relative bg-slate-950 overflow-hidden items-center justify-center border-l border-white/5">
          ...
          <div className="absolute bottom-1/4 -left-20 w-[600px] h-[600px] bg-purple-600/20 rounded-full blur-[140px] animate-pulse" style={{ animationDelay: '2s' }} />
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            ...
            <p className="text-base text-muted-foreground mt-2 max-w-xl">
              Your real-time management dashboard. Monitor leads, analyze inquiries, and track engagement seamlessly.
            </p>
          </div>
          ...
          return (
            ...
            >
              ...
              <CardHeader className="flex flex-row items-center justify-between pb-2 relative z-10">
                ...
                <div className={`p-3 rounded-2xl ${card.color} shadow-inner transition-transform group-hover:scale-110 duration-300`}>
                  <Icon className="h-5 w-5" />
                </div>
              </CardHeader>
              <CardContent className="relative z-10">
                <div className="text-4xl font-black text-foreground tracking-tight">{card.value}</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="lg:col-span-2 border-white/10 bg-background/40 backdrop-blur-xl shadow-lg relative overflow-hidden">
          ...
          <CardHeader>
            ...
            <CardDescription className="text-sm font-medium">Overview of lead categories in your system</CardDescription>
          </CardHeader>
            ...
            <div className="group flex items-center justify-between p-4 rounded-2xl bg-muted/30 border border-white/5 hover:border-white/20 hover:bg-muted/50 transition-all duration-300 cursor-default">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground font-medium">General inquiries from prospective clients</p>
                </div>
              </div>
            ...
            <div className="group flex items-center justify-between p-4 rounded-2xl bg-muted/30 border border-white/5 hover:border-white/20 hover:bg-muted/50 transition-all duration-300 cursor-default">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground font-medium">Project estimates with budget & timeline specs</p>
                </div>
              </div>
