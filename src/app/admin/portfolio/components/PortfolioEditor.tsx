        ...
        <DialogHeader className="px-6 py-4 border-b border-border/40 sticky top-0 bg-background/80 backdrop-blur-md z-10 flex flex-row items-center justify-between">
          <div className="flex items-center justify-between w-full pr-8">
            <div>
              ...
              <DialogDescription>Portfolio Showcase</DialogDescription>
            </div>
          ...
          >
            ...
            <Tabs defaultValue="metadata" className="w-full">
              <TabsList className="grid w-full grid-cols-2 md:grid-cols-4 mb-8 h-auto p-1">
                <TabsTrigger value="metadata" className="py-2">
                  <Settings className="h-4 w-4 mr-2 hidden md:block" /> Details
                </TabsTrigger>
                <TabsTrigger value="stack" className="py-2">
                  <Code className="h-4 w-4 mr-2 hidden md:block" /> Tech Stack
                </TabsTrigger>
                <TabsTrigger value="casestudy" className="py-2">
                  <FileText className="h-4 w-4 mr-2 hidden md:block" /> Case Study
                </TabsTrigger>
