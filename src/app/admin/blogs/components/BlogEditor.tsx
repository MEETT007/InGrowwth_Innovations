    ...
    <div className="max-w-6xl mx-auto pb-24">
      ...
      <div className="sticky top-0 z-50 bg-background/80 backdrop-blur-xl border-b border-border/50 p-4 mb-8 -mx-4 sm:-mx-8 px-4 sm:px-8 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="font-semibold text-lg">{initialData?.id ? 'Edit Post' : 'New Post'}</h1>
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          {/* Cover Image Upload (Premium Style) */}
          <div className="relative group rounded-2xl border-2 border-dashed border-border/50 bg-muted/20 hover:bg-muted/40 transition-colors overflow-hidden flex flex-col items-center justify-center min-h-[300px]">
            {thumbnailPreview ? (
              <>
          ...
          <div className="space-y-2">
            {/* Minimalist Editor Textarea (Later can be swapped with TipTap) */}
            <Textarea
              placeholder="Write your story..."
              className="min-h-[500px] text-lg leading-relaxed border-none bg-transparent px-0 focus-visible:ring-0 shadow-none resize-y placeholder:text-muted-foreground/40 font-serif"
